...
BOOST_DATE_TIME_LIB="${ac_boost_path}/lib/`echo ${BOOST_DATE_TIME_LIB}| sed 's/-l\(.*\)\$/lib\1.a/'`"
BOOST_FILESYSTEM_LIB="${ac_boost_path}/lib/`echo ${BOOST_FILESYSTEM_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_IOSTREAMS_LIB="${ac_boost_path}/lib/`echo ${BOOST_IOSTREAMS_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_PROGRAM_OPTIONS_LIB="${ac_boost_path}/lib/`echo ${BOOST_PROGRAM_OPTIONS_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_REGEX_LIB="${ac_boost_path}/lib/`echo ${BOOST_REGEX_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_SYSTEM_LIB="${ac_boost_path}/lib/`echo ${BOOST_SYSTEM_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_THREAD_LIB="${ac_boost_path}/lib/`echo ${BOOST_THREAD_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
BOOST_WAVE_LIB="${ac_boost_path}/lib/`echo ${BOOST_WAVE_LIB}| sed 's/-l\(.*\)$/lib\1.a/'`"
